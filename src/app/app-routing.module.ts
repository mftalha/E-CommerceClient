...
const routes: Routes = [
  // her bir extra layout için admin'deki işlemi gerçekleştiriyoruz
  {
    path: "admin", component: LayoutComponent,children: [ //url de admin geldiğinde
      ...
      // burda loadChildren ile yaptığımız iş lazd load işinede yarıyor.
    ]
  },
...
@NgModule({
  imports: [RouterModule.forRoot(routes)], // routun son hali buraya çekiliyor.
  exports: [RouterModule] // yapılan çalışma export ediliyorki : ana çalışmada kullanılabilsin
})
