...
declare var alertify: any; // alertfy kütüphanesini kullanabilmek için = içinden bir nesneyi böyle build etmem gerkeiyor. 


@Injectable({
  providedIn: 'root' // kullanmak istediğim dosya yolunun = component.ts sinde priveders: [] içine root'u eklediğimde ios contniere daki buna depending enjection ile erişim sağlatabilriiz ilgili component üyelerinden == ama biz yine deppending injection ile componentler den farklı bir yöntem ile çağıracaz.
})
